...
--eww
--hl.bind("ALT + O" ,hl.dsp.exec_cmd("hyprlock"))
...
hl.bind("SUPER + F10" ,hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle"))
...
hl.bind("F1", hl.dsp.exec_cmd("hyprctl reload"), { release = true })
